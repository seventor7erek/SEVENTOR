...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .st-wa-btn:hover { background: rgba(37, 211, 102, 0.2); }
      .st-wa-btn:active { transform: scale(0.96); }
  ...
  function renderMessages() {
    ...
    messages.forEach(function (msg) {
      ...
      // Add WhatsApp button after bot messages that suggest contacting the team
      if (msg.role === 'assistant' && /whatsapp|واتساب|click|team directly|تواصل|contact/i.test(msg.content)) {
        const waBtn = document.createElement('a');
        waBtn.href = 'https://wa.me/971544117716?text=' + encodeURIComponent('Hi SEVENTOR, I\'d like to inquire about your services.');
        waBtn.target = '_blank';
        waBtn.rel = 'noopener';
        waBtn.className = 'st-wa-btn';
        waBtn.innerHTML = '<svg viewBox="0 0 24 24" width="16" height="16" fill="#25D366"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.117.553 4.106 1.52 5.834L.053 23.52a.5.5 0 00.607.607l5.686-1.467A11.94 11.94 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.94 0-3.76-.556-5.303-1.517l-.37-.223-3.84.99.99-3.84-.223-.37A9.935 9.935 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/></svg>' +
          (getLang() === 'ar' ? ' تواصل عبر واتساب' : ' Chat on WhatsApp');
